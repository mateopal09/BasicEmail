...
export const selectedEmailContext = createContext({actualEmail: {"sender_id": "no-selected", "sender_name": "no-selected",  "sender_email": "no-selected", "sender_photo": "no-selected", "subject": "no-selected", "body": "no-selected", "timestamp": "no-selected"}, setActualEmail: (_actualView:MessageProps) => {}});

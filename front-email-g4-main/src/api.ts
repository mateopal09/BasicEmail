...
export const getEmails = (currentUser: string) => {
  return axios.get(
    "http://54.202.119.143:2000/api/recieve-email/" + currentUser,
    { withCredentials: true }
  );
};
...
export const postEmail = (subject: string, email: string, body: string) => {
  console.log({ recipient_email: email, subject: subject, body: body });
  return axios.post(
    "http://54.202.119.143:2000/api/send-email/",
    { recipient_email: email, subject: subject, body: body },
    { withCredentials: true }
  );
};
...
export const getUser = (email: string, password: string) => {
  return axios.post(
    "http://54.202.119.143:2000/api/login/",
    { email: email, password: password },
    { withCredentials: true }
  );
};
...
export const postUser = (
  ...
  return axios.post(
    "http://54.202.119.143:2000/api/register/",
    {
      name: name,
      email: email,
      password: password,

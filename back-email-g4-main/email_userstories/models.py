...
class MyUserManager(BaseUserManager):
    ...
    def create_user(self, **kwargs):
        ...
        user.set_password(kwargs['password']) #encrypted_password)
        user.name = kwargs['name']
        user.photo_profile = kwargs.get('photo_profile', None)
...
class Emails(models.Model):
    ...
    Parameters:
    - models.model: We heritage Model from models
      to use the django ORM for creating the table
